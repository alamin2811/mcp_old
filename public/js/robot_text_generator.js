    ...
    var msg2 = '# robots.txt generated by '+_APP_URL+' \n';
    var ovtxt;
    function genRobotsResult(form,msg1,msg2) {
        if (confirm(msg1)){
        ...
        download('robots.txt', 'text/plain'); 
    }
    ...
    function showMore(id,c) {
        $('#'+id).toggleClass('displaynone','equally_centralized');
        $(c).toggleClass('fa-plus-circle fa-minus-circle');
    }